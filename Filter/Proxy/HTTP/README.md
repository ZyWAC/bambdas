...
```
## [DetectSQLErrors.bambda](https://github.com/PortSwigger/bambdas/blob/main/Filter/Proxy/HTTP/DetectSQLErrors.bambda)
### Detects SQL error messages in responses for MySQL, PostgreSQL, Oracle, SQL Server, SQLite, MariaDB, IBM DB2, and generic ODBC/OLE DB drivers. Also detects ORM/framework-level errors from PDO, Hibernate, Django, and ActiveRecord.
#### Author: whoamins
```java
